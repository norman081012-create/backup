...
TRANSLATIONS = {
    ...
    "計畫達成獎勵金 (提供給執行方的總預算，最高不超過當年總預算)": "Total Plan Reward (Max=Budget)",
    "計畫總效益 (預期增加之 GDP 與基礎建設)": "Plan Total Benefit (GDP & Infra Expected)",
    "💰 資金分配調整 (監管出撿額)": "💰 Funding Distribution (R-Pays)",
    "監管出資": "R-Pays",
    "執行出資": "H-Pays",
    "總額": "Total",
    "出資總額": "Total Req. Cost",
    ...
    "切換以 公告數字 試算 (預設為智庫/真實預估)": "Toggle to use Claimed Values (Default: True/Think Tank)",
    "📤 送出常規草案": "📤 Submit Draft",
    ...
    # [修改] 更新衰退率與單價分析的多語系辭典
    "中度風險 (公告衰退率與預期略有出入，可能影響選民心理預期)": "🟡 Med Risk (Slight discrepancy in decay, affects psychological expectation)",
    "差異極小 (公告衰退率誠實，無心理預期操弄空間)": "🟢 Low Risk (Honest decay claim, no expectation manipulation)",
    "研判對手惡意高估衰退率，企圖製造恐慌以降低施政期望，收割預期反差紅利！": "🔴 High Risk (Exaggerating decay to lower expectations & harvest contrast bonus)",
    "研判對手低估衰退率，粉飾太平，若最終施政未達標將遭民意反噬！": "🔴 High Risk (Understating decay to paint a rosy picture, risks backlash)",
    ...
    "判讀": "Analysis",
    "情報": "Intel",
    "單位產出成本": "Cost per Unit Output",
    "基於觀測對手工程能力預算": "Calculated via observed opp. engineering output",
    "📈 升級花費": "📈 Upgrade Cost",
    "維護費將達": "Maint reaches",
    "📉 降級退回": "📉 Downgrade",

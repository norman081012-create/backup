...
TRANSLATIONS = {
    ...
    "無施政估值判讀": "Drop Analysis",
    "建設單價判讀": "Unit Cost Analysis",
    
    # [修改] 更新跌幅字典
    "中度風險 (公告跌幅與預期略有出入，可能影響選民心理預期)": "🟡 Med Risk (Slight discrepancy in drop, affects psychological expectation)",
    "差異極小 (公告跌幅誠實，無心理預期操弄空間)": "🟢 Low Risk (Honest drop claim, no expectation manipulation)",
    "研判對手惡意高估無施政跌幅。企圖製造恐慌降低施政期望，藉此收割反差紅利！": "🔴 High Risk (Exaggerating drop to lower expectations & harvest contrast bonus)",
    "研判對手低估無施政跌幅粉飾太平。若最終施政未達標將遭民意反噬！": "🔴 High Risk (Understating drop to paint a rosy picture, risks backlash)",
    ...
    "貪污查緝能力評估": "Anti-Corruption Estimate",
    "📈 升級花費": "📈 Upgrade Cost",
    "維護費將達": "Maint reaches",
    "📉 降級退回": "📉 Downgrade",

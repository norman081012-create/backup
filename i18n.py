...
TRANSLATIONS = {
    ...
    "中度風險 (數據略有出入，需留意預算流失)": "🟡 Med Risk",
    "差異極小 (公告與智庫基準相符，屬正常估值)": "🟢 Low Risk",
    "研判對手惡意高估衰退率，企圖製造恐慌騙取紅利與支持！": "🔴 High Risk (Opp. exaggerating bad economy for support)",
    "研判對手高估衰退率，意圖墊高阻力預期，套取過高獎勵金！": "🔴 High Risk (Opp. exaggerating bad economy for funds)",
    "研判對手低估衰退率，意圖苛扣我方資源與獎勵！": "🔴 High Risk (Opp. exaggerating good economy to cut funds)",
    "研判對手低估衰退率，企圖掩蓋困境並收割自然成長紅利！": "🔴 High Risk (Opp. exaggerating good economy to ride the wave)",
